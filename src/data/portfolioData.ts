...
export const HERO_DATA = {
  ...
  skills: ['FULL-STACK', 'AI', 'CYBERSECURITY', 'ESPORTS'],
  resumeUrl: '',
};
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    fullDescription: [
      'SurakshaVerse is a web-based cybersecurity awareness and training platform designed to make security learning more practical and interactive.',
      ...
      'A separate AI-assisted threat analysis module demonstrates how simulated telemetry can be analysed using machine-learning techniques to identify unusual behaviour and present security insights.',
      'The project is designed as a controlled learning and analytics environment. It does not perform real-world cyber attacks, packet sniffing, or live network monitoring.'
    ],
    ...
    codeUrl: 'https://github.com/gauravphutane11/SurakshaVerse.git',
    liveUrl: '',
  },

  {
    ...
    fullDescription: [
      ...
      'The project focuses on creating a simple digital environment for peer-to-peer knowledge exchange, collaboration, and skill discovery.'
    ],
...

  {
    ...
    fullDescription: [
      ...
      'The project explores how facial features, visual references, and fragmented witness information can be organized into a more systematic investigation process.',
      'SmartSketch was selected as a Finalist / Final Project at DIPEX 2025, with the project focused on applying AI concepts to forensic investigation and visual evidence analysis.',
      'The project is presented as an academic and innovation-focused system concept rather than a deployed forensic investigation product.'
    ],
...

  {
    ...
    liveUrl: 'https://resource-link-eight.vercel.app/feed',
    codeUrl: '',
  },
];
...
export const EXPERIENCE_DATA: Experience[] = [
...

  {
    ...
    tags: ['Tournament Ops', 'Event Admin', 'LAN Events'],
...
export const ESPORTS_DATA: EsportsHighlight = {
  ...
  topTournaments: [
    ...
    },
    {
      ...
      details: 'Collegiate National Circuit'
    },
    {
      ...
      placement: '1ST PLACE',
      prize: '₹10,000',
      details: 'On-Ground LAN Championship'
    },
    {
      event: 'COEP BGMI LAN',
      year: '2023',
    ...
    },
    {
      ...
      placement: '#6 RANK',
      prize: '₹1,00,000 Pool',
      details: 'State-Level Invitational'
    },
    {
      ...
      details: 'Annual Polytechnic Fest'
    },
    {
      event: 'JSPM BGMI LAN',
      year: '2022',
...
export const ACHIEVEMENTS_DATA: Achievement[] = [
  {
    ...
    category: 'DIPEX 2025 · FINALIST / FINAL PROJECT',

    placement: 'FINALIST / FINAL PROJECT',
...

  {
    ...
    category: 'ESPORTS · SELECTED RECORD',
    ...
    description:
      '1st-place finish in the collegiate esports circuit playoffs at AISSMS.',
...

  {
    ...
    description:
      '1st-place finish at a Bharati College on-ground LAN tournament.',
...

  {
    ...
    category: 'ESPORTS · COLLEGIATE RECORD',
    ...
    description:
      '1st-place finish in an inter-college BGMI LAN tournament.',
...

  {
    ...
    category: 'ESPORTS · COMPETITIVE RECORD',
    ...
    description:
      '4th-place finish in a collegiate BGMI LAN competition.',
...

  {
    ...
    description:
      'Top-6 placement in a state-level collegiate BGMI competition.',
...

  {
    ...
    category: 'ESPORTS · REGIONAL RECORD',
    ...
    description:
      'Top-10 placement in a regional collegiate LAN competition.',
...
export const ABOUT_DATA = {
  tagline: 'I BUILD. I EXPERIMENT. I COMPETE.',
  ...
  education: [
...

    {
      ...
      statusOrScore: '92.93% · Distinction'
    }
  ] as Education[]
};
...
export function getDetailDataFor(
  ...
  if (type === 'esports') {
    return {
      ...
      category: 'ESPORTS & COMPETITIVE ARCHIVE',

      title: 'COMPETITIVE GAMING & OPERATIONS',

      subtitle: 'BGMI Competitive Player & Tournament Administrator',

      description: [
        'Competitive BGMI player with experience in collegiate LAN tournaments and campus-level esports events.',

        'Experience supporting on-ground tournament operations, LAN coordination, scheduling, bracket management, and live event administration.',

        'The esports side of the portfolio combines competitive participation with practical event operations experience.'
      ],
      ...
      media: [
        {
          ...
          caption: 'Collegiate Esports Event'
        },

        {
          ...
          caption: 'LAN Tournament Operations'
        }
      ],
      ...
      metadata: [
        ...
        {
          label: 'ROSTER',
          value: 'Naye Khiladi R2 / Trident Ignite R2'
        },

        {
          label: 'TOP RESULT',
          value: '1st Place — College Rivals @ AISSMS'
        },

        {
          label: 'OPERATIONS',
          value: 'College LAN & Esports Events'
        }
      ],
  ...
  if (type === 'achievement') {
    ...
    const descriptionParagraphs = isFeaturedDipex
      ? [
        ach.description,

        'DIPEX 2025 is presented here as the project milestone associated with SmartSketch. The project focused on applying AI and computer-vision concepts to a forensic investigation use case.',

        'The portfolio intentionally presents SmartSketch as an academic innovation project and concept rather than claiming it as a deployed forensic product.'
      ]
      : [
        ach.description,
  ...
  if (type === 'certification') {
    const cert = CERTIFICATIONS_DATA.find(
      (c) => c.id === id
    );
    ...
    return {
      ...
      category: 'AWS EDUCATE · LEARNING CREDENTIAL',

      title: cert.title.toUpperCase(),
      ...
      description: [
        ...
        'This credential represents structured learning in an AWS-related technical area and forms part of the cloud, AI, security, and networking learning path.'
      ],
      ...
      media: [
        {
          url:
            'https://lh3.googleusercontent.com/aida-public/AB6AXuAbQ9AJkdTx6k9yGPLiB4uXGz_P1GOdzEr1fr0dqHH2RW5_iDGXO0yELyxKzzj6lRurqoptVVspfiWaDlD_ulIU66tCHzxmeZ8K5pKYJ9GXXMmolPL-O5OH881WL16wEakzsfIs-rYYvWoHJ2RHZQ5HjLJ7NThqh3AeDHIIJYLYwYBEz_nQU7e3hY0Pm5CjiE7xaiyTDugzvF-IrSx548IexUWqQ2FG6-Nfg4KLwPhdKC7ObRCvw12_nw',
          alt: `${cert.title} AWS Educate Badge`,
          caption: 'AWS Educate Learning Credential'
        }
      ],
      ...
      metadata: [
        ...
        {
          label: 'CATEGORY',
          value: cert.category.toUpperCase()
        }
      ],
  ...
  if (type === 'about') {
    return {
      ...
      media: [
        {
          url: ABOUT_DATA.portraitImage,
          alt: 'Gaurav Phutane Profile',
          caption: 'Engineer & Competitor'
        }
      ],
      ...
      metadata: [
        ...
        {
          label: 'PREVIOUS',
          value: 'Diploma in Engineering · 92.93%'
        },
      ...
      secondaryAction: HERO_DATA.resumeUrl
        ? {
          label: 'VIEW RESUME',
          url: HERO_DATA.resumeUrl
        }
        : undefined
    };
  }
